 ...
 *
 * @brief
 * Check to throw an error if WEAVE_CONFIG_TUNNEL_ENABLE_TCP_IDLE_CALLBACK is
 * explicitly set without INET_CONFIG_ENABLE_TCP_SEND_IDLE_CALLBACKS being set.
 *
 */
#if (WEAVE_CONFIG_TUNNEL_ENABLE_TCP_IDLE_CALLBACK && !(INET_CONFIG_ENABLE_TCP_SEND_IDLE_CALLBACKS))
#error WEAVE_CONFIG_TUNNEL_ENABLE_TCP_IDLE_CALLBACK requires INET_CONFIG_ENABLE_TCP_SEND_IDLE_CALLBACKS to be enabled
#endif // WEAVE_CONFIG_TUNNEL_ENABLE_TCP_IDLE_CALLBACK
